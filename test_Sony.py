...
#创建input tensor 对象
tensor_info_input = tf.saved_model.utils.build_tensor_info(in_image)
#创建output tensor 对象
tensor_info_output = tf.saved_model.utils.build_tensor_info(out_image)

#创建signature
prediction_signature = (tf.saved_model.signature_def_utils.build_signature_def(
                                            inputs={"input_image":tensor_info_input},
                                            outputs={"output_image":tensor_info_output},
                                            method_name=tf.saved_model.signature_constants.PREDICT_METHOD_NAME
                                            ))

builder.add_meta_graph_and_variables(sess, [tf.saved_model.tag_constants.SERVING],
                                        signature_def_map={"output":prediction_signature})
